...
export const Loans = () => {
    ...
    return (
        <div>
            {/* Desktop */}
            <div className='d-none d-lg-block mt-2' style={{ backgroundColor: '#E9F1FA' }}>
                        ...
                        {shelfCurrentLoans.map(shelfCurrentLoan => (
                            <div key={shelfCurrentLoan.book.id}>
                                <div className='row mt-3 mb-3'>
                                    ...
                                    <div className='card col-3 col-md-3 container d-flex' style={{ backgroundColor: '#E9F1FA' }}>
                                        <div className='card-body'>
                                            <div className='mt-3'>
                                                ...
                                                <div className='list-group mt-3 ' >
                                                    <button className='list-group-item list-group-item-action'
                                                        ...
                                                        data-bs-target={`#modal${shelfCurrentLoan.book.id}`} style={{ backgroundColor: '#E9F1FA' }}>
                                                        Manage Loan
                                                    </button>
                                                    <Link to={'search'} className=' list-group-item list-group-item-action' style={{ backgroundColor: '#E9F1FA' }}>
                                                        Search more books?
                                                    </Link>
                                                </div>
                                            </div>
                                            ...
                                            <Link className='btn btn-primary' style={{
                                                ...
                                                backgroundColor: '#7e7ad2' // Background color, adjust as needed
