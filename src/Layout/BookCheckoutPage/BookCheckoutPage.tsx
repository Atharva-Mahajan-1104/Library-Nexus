...
export const BookCheckoutPage = () => {
    ...
    useEffect(() => {
        ...
        fetchBook();
    }, [bookId, isCheckedOut]); // Added bookId to dependencies
    ...
    useEffect(() => {
        ...
        fetchBookReviews();
    }, [bookId, isReviewLeft]); // Added bookId to dependencies
    ...
    useEffect(() => {
        ...
        fetchUserReviewBook();
    }, [authState, bookId]); // Added bookId to dependencies
    ...
    }, [authState, isCheckedOut]); // Added authState to dependencies
    ...
    return (
        <div style={{ backgroundColor: '#E9F1FA' }}>
