...
export const LoansModal: React.FC<{ shelfCurrentLoan: ShelfCurrentLoans, mobile: boolean,returnBook:any,renewloans:any }> = (props) => {
    return (
                                ...
                                <div className='mt-3'>
                                    ...
                                    <div className='list-group mt-3'>
                                        ...
                                        onClick={   props.shelfCurrentLoan.daysLeft < 0 ? 
                                            ...
                                            :
                                            () => props.renewloans(props.shelfCurrentLoan.book.id)}
